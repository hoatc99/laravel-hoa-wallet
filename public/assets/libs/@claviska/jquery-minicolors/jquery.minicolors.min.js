...
!function(i) {
  ...
  function s(i) {
      ...
      o.animate ? o.stop(!0, !0).fadeIn(s.showSpeed, function() {
  ...
  function n(i, t, o) {
      var s, a, n, r, e, c = i.parents(".minicolors").find(".minicolors-input"), l = c.data("minicolors-settings"), h = i.find("[class$=-picker]"), d = i.offset().left, p = i.offset().top, u = Math.round(t.pageX - d), g = Math.round(t.pageY - p), m = o ? l.animationSpeed : 0;
      ...
      h.animate ? h.stop(!0).animate(e, m, l.animationEasing, function() {
          f(c, i)
      }) : (h.css(e),
      f(c, i))
  }
  function f(i, t) {
      ...
      var s, a, n, r, e, c, l, h = i.val(), d = i.attr("data-opacity"), p = i.parent(), u = i.data("minicolors-settings"), g = p.find(".minicolors-input-swatch"), m = p.find(".minicolors-grid"), f = p.find(".minicolors-slider"), v = p.find(".minicolors-opacity-slider"), b = m.find("[class$=-picker]"), w = f.find("[class$=-picker]"), y = v.find("[class$=-picker]"), C = o(b, m), k = o(w, f), M = o(y, v);
      if (t.is(".minicolors-grid, .minicolors-slider, .minicolors-opacity-slider")) {
          ...
          case "wheel":
              ...
              75 < c && (c = 75,
              C.x = 69 - 75 * Math.cos(l),
              C.y = 69 - 75 * Math.sin(l)),
              a = F(c / .75, 0, 100),
              h = q({
  ...
  function x(i, t, o) {
      ...
      t = "rgb" === n.format ? (s = T(t) ? I(t, !0) : L(M(t, !0)),
      o = "" === i.attr("data-opacity") ? 1 : F(parseFloat(i.attr("data-opacity")).toFixed(2), 0, 1),
      !isNaN(o) && n.opacity || (o = 1),
      i.minicolors("rgbObject").a <= 1 && s && n.opacity ? "rgba(" + s.r + ", " + s.g + ", " + s.b + ", " + parseFloat(o) + ")" : "rgb(" + s.r + ", " + s.g + ", " + s.b + ")") : (T(t) && (t = j(t)),
      k(t, n.letterCase)),
      i.val(t),
      r.find("span").css({
          backgroundColor: t,
  ...
  function d(i, t) {
      var o, s, a, n, r, e, c, l, h, d, p = i.parent(), u = i.data("minicolors-settings"), g = p.find(".minicolors-input-swatch"), m = p.find(".minicolors-grid"), f = p.find(".minicolors-slider"), v = p.find(".minicolors-opacity-slider"), b = m.find("[class$=-picker]"), w = f.find("[class$=-picker]"), y = v.find("[class$=-picker]");
      switch (T(i.val()) ? (o = j(i.val()),
      (r = F(parseFloat(D(i.val())).toFixed(2), 0, 1)) && i.attr("data-opacity", r)) : o = k(M(i.val(), !0), u.letterCase),
      s = function(i) {
          var t = function(i) {
              var t = {
                  h: 0,
      ...
      n = u.keywords ? C.map(u.keywords.split(","), function(i) {
          return i.toLowerCase().trim()
      }) : [],
      e = "" !== i.val() && -1 < C.inArray(i.val().toLowerCase(), n) ? k(i.val()) : T(i.val()) ? I(i.val()) : o,
      t || i.val(e),
      u.opacity && (a = "" === i.attr("data-opacity") ? 1 : F(parseFloat(i.attr("data-opacity")).toFixed(2), 0, 1),
      isNaN(a) && (a = 1),
      ...
      u.control) {
      case "wheel":
          h = F(Math.ceil(.75 * s.s), 0, m.height() / 2),
          d = s.h * Math.PI / 180,
  ...
  function I(i, t) {
      ...
      return o[0] = F(parseInt(o[0], 10), 0, 255),
  ...
  function q(i) {
      ...
      0 === e ? n.r = n.g = n.b = c : (a = r % 60 * ((o = c) - (s = (255 - e) * c / 255)) / 60,
      360 === r && (r = 0),
      r < 60 ? (n.r = o,
      n.b = s,
      n.g = s + a) : r < 120 ? (n.g = o,
      ...
      minicolors: function(i, t) {
          ...
          case "rgbObject":
              return function(i) {
                  ...
                  {
                      var s;
                      t = T(C(i).val()) ? I(C(i).val(), !0) : (s = M(C(i).val(), !0),
                      L(s))
                  }
                  if (!t)
                      return null;
          ...
          case "rgbaString":
              return function(i, t) {
                  ...
                  {
                      var a;
                      o = T(C(i).val()) ? I(C(i).val(), !0) : (a = M(C(i).val(), !0),
                      L(a))
                  }
                  if (!o)
                      return null;
          ...
          case "settings":
              return void 0 === t ? C(this).data("minicolors-settings") : (C(this).each(function() {
                  ...
                  o(C(this)),
                  C(this).minicolors(C.extend(!0, i, t))
              }),
              C(this));
          case "show":
              return s(C(this).eq(0)),
              C(this);
          case "value":
              return void 0 === t ? C(this).val() : (C(this).each(function() {
                  "object" == typeof t && null !== t ? (void 0 !== t.opacity && C(this).attr("data-opacity", F(t.opacity, 0, 1)),
                  t.color && C(this).val(t.color)) : C(this).val(t),
                  d(C(this))
              }),
              C(this));
          default:
              ...
              C(this).each(function() {
                  !function(t, i) {
                      ...
                      if (t.data("minicolors-initialized"))
                          return;
                      i = C.extend(!0, {}, h, i),
                      l.addClass("minicolors-theme-" + i.theme).toggleClass("minicolors-with-opacity", i.opacity),
                      void 0 !== i.position && C.each(i.position.split(" "), function() {
                          l.addClass("minicolors-position-" + this)
                      });
                      s = "rgb" === i.format ? i.opacity ? "25" : "20" : i.keywords ? "11" : "7";
                      t.addClass("minicolors-input").data("minicolors-initialized", !1).data("minicolors-settings", i).prop("size", s).wrap(l).after('<div class="minicolors-panel minicolors-slider-' + i.control + '"><div class="minicolors-slider minicolors-sprite"><div class="minicolors-picker"></div></div><div class="minicolors-opacity-slider minicolors-sprite"><div class="minicolors-picker"></div></div><div class="minicolors-grid minicolors-sprite"><div class="minicolors-grid-inner"></div><div class="minicolors-picker"><div></div></div></div></div>'),
                      i.inline || (t.after('<span class="minicolors-swatch minicolors-sprite minicolors-input-swatch"><span class="minicolors-swatch-color"></span></span>'),
                      ...
                      i.swatches && 0 !== i.swatches.length)
                          for (e.addClass("minicolors-with-swatches"),
                          a = C('<ul class="minicolors-swatches"></ul>').appendTo(e),
                          c = 0; c < i.swatches.length; ++c)
                              n = "object" == typeof i.swatches[c] ? (o = i.swatches[c].name,
                              i.swatches[c].color) : (o = "",
                              i.swatches[c]),
                              n = T(r = n) ? I(n, !0) : L(M(n, !0)),
                              C('<li class="minicolors-swatch minicolors-sprite"><span class="minicolors-swatch-color"></span></li>').attr("title", o).appendTo(a).data("swatch-color", r).find(".minicolors-swatch-color").css({
  ...
  C([document]).on("mousedown.minicolors touchstart.minicolors", function(i) {
      ...
      var t = C(this);
      i.preventDefault(),
      C(i.delegateTarget).data("minicolors-target", t),
      n(t, i, !0)
      ...
      a = "" !== n.val() && -1 < C.inArray(n.val().toLowerCase(), i) ? n.val() : null === (o = T(n.val()) ? I(n.val(), !0) : (t = M(n.val(), !0)) ? L(t) : null) ? r.defaultValue : "rgb" === r.format ? r.opacity ? I("rgba(" + o.r + "," + o.g + "," + o.b + "," + n.attr("data-opacity") + ")") : I("rgb(" + o.r + "," + o.g + "," + o.b + ")") : p(o),
      s = r.opacity ? n.attr("data-opacity") : 1,
      "transparent" === a.toLowerCase() && (s = 0),
      n.closest(".minicolors").find(".minicolors-input-swatch > span").css("opacity", String(s)),
      n.val(a),
