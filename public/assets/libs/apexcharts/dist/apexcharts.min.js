    ...
    , m = function() {
      ...
      return r(t, [{
          ...
          value: function(t) {
              ...
              l = l || "regular",
              (e = Array.isArray(s) ? f.globals.dom.Paper.text((function(t) {
      ...
      return r(t, [{
          ...
          value: function(t, e, i) {
              ...
              if (void 0 === s.fill.gradient.gradientToColors || 0 === s.fill.gradient.gradientToColors.length)
                  ...
                  a = g,
                  g.indexOf("rgba") > -1 && (d = x.getOpacityFromRGBA(g))
              } else
                  a = t;
              ...
              return h.indexOf("rgb") > -1 && (h = x.rgb2hex(h)),
    ...
    , Y = function() {
      ...
      return r(t, [{
          ...
          value: function(t) {
              ...
              d.config.chart.stacked && (this.barCtx.yArrj.push(p.y2),
          ...
          value: function(t, e, i, a, s) {
              ...
              void 0 !== i[a][s] || null !== i[a][s]) {
                  ...
                  p && (o *= -1),
                  u += o,
                  g = r.quadraticCurve(e.barXPosition, u - o, e.barXPosition + (p ? -1 * o : o), u - o) + r.line(e.barXPosition + e.barWidth - e.strokeWidth - (p ? -1 * o : o), u - o) + r.quadraticCurve(e.barXPosition + e.barWidth - e.strokeWidth, u - o, e.barXPosition + e.barWidth - e.strokeWidth, u)
              }
              return {
                  pathWithRadius: g,
                  y2: u
      ...
      return r(t, [{
          ...
          value: function(t) {
              ...
              if (h.globals.isXNumeric) {
                  ...
                  i = (h.globals.seriesX[p][g] - h.globals.minX) / this.xRatio - r * this.seriesLen / 2
              }
      ...
      return r(s, [{
              ...
              for (var r = s.group({
                  ...
                  for (var y = s.group({
                      ...
                      this.isHorizontal) {
                          ...
                          f = (L = this.drawRangeColumnPaths(e({
                              indexes: {
                                  i: o,
                                  j: k,
                                  realIndex: u
          ...
          value: function(t) {
              ...
              if (void 0 === o.config.tooltip.x.formatter)
                  ...
                  p = o.config.tooltip.x.formatter(n),
                  f = o.config.tooltip.x.formatter(l);
              return {
                  start: n,
                  end: l,
                  startVal: p,
    ...
    , B = function() {
      ...
      return r(t, [{
          ...
          value: function(t) {
              ...
              s.hasGroups = "category" === a.xaxis.type && void 0 !== a.xaxis.group && void 0 !== a.xaxis.group.groups && a.xaxis.group.groups.length > 0,
    ...
    , j = function() {
      ...
      return r(t, [{
          ...
          value: function(t) {
                  ...
                  o.globals.axisCharts ? function(t, e) {
                      ...
                      t.data && t.data.length)
                          for (var s = 0; s < t.data.length; s++) {
                              ...
                              0 === e) {
                                  n.push((d = r,
                                  "datetime" === o.config.xaxis.type && String(d).length >= 10 ? o.config.chart.toolbar.export.csv.dateFormatter(r) : x.isNumber(r) ? r : r.split(a).join("")));
              ...
              h += l.join(r),
              this.triggerDownload("data:text/csv; charset=utf-8," + encodeURIComponent("\ufeff" + h), o.config.chart.toolbar.export.csv.filename, ".csv")
          }
      }, {
          key: "triggerDownload",
          value: function(t, e, i) {
          ...
          value: function(t) {
              ...
              if (g.show)
                  for (var u = function(o) {
                      ...
                      if (f.textContent = Array.isArray(n) ? n.join(" ") : n,
      ...
      return r(t, [{
          ...
          value: function(t) {
              ...
              if ("heatmap" === e.config.chart.type || this.isBarsDistributed) {
                  ...
                  !t.target.classList.contains("apexcharts-inactive-legend") && i && new E(this.ctx).toggleSeriesOnHover(t, t.target)
          }
      }, {
          key: "onLegendClick",
          value: function(t) {
              ...
              if (void 0 !== t || void 0 !== e) {
                  ...
                  e - t < 2))) {
                      ...
                      if (i.config.chart.zoom.autoScaleYaxis)
                          o = new q(this.ctx).autoScaleY(this.ctx, o, {
                              xaxis: a
                          });
          ...
          value: function(t, e, i, a, s) {
              ...
              if (o.config.legend.tooltipHoverFormatter) {
                  ...
                  for (var g = 0; g < d.length; g++) {
                      ...
                      if (r)
                          u.innerHTML = o.globals.collapsedSeriesIndices.indexOf(p) < 0 ? x : f;
                      else if (u.innerHTML = p === i ? x : f,
                      i === p)
                          break
                  }
              }
      ...
      return r(t, [{
          ...
          value: function(t) {
              for (var e = t.series, i = t.realIndex, a = t.i, s = t.x, r = t.y, o = t.pX, n = t.pY, l = t.pathsFrom, h = t.linePaths, c = t.areaPaths, d = t.seriesIndex, g = t.lineYPosition, u = t.xArrj, p = t.yArrj, f = this.w, b = new m(this.ctx), v = this.yRatio, y = l.prevY, w = l.linePath, k = l.areaPath, A = l.pathFromLine, S = l.pathFromArea, C = x.isNumber(f.globals.minYArr[i]) ? f.globals.minYArr[i] : f.globals.minY, L = f.globals.dataPoints > 1 ? f.globals.dataPoints - 1 : f.globals.dataPoints, P = 0; P < L; P++) {
                  ...
                  k = z.areaPath,
                  w = z.linePath,
                  this.appendPathFrom && (A += b.line(s, this.zeroY),
                  S += b.line(s, this.zeroY)),
          ...
          value: function(t) {
              ...
              "smooth" === x) {
                  ...
                  c = f.move(n, l) + "z")),
                  d.push(h),
                  g.push(c)) : (h += f.curve(n + v, l, r - v, o, r, o),
                  c += f.curve(n + v, l, r - v, o, r, o)),
                  n = r,
                  l = o,
                  s === e[i].length - 2 && (c = c + f.curve(n, l, r, o, r, b) + f.move(r, o) + "z",
                  p.globals.hasNullValues || (d.push(h),
                  g.push(c)))
              } else {
                  if (null === e[i][s + 1]) {
                      h += f.move(r, o);
                  ...
                  null === e[i][s] && (h += f.move(r, o),
                  c += f.move(r, b)),
                  "stepline" === x ? (h = h + f.line(r, null, "H") + f.line(null, o, "V"),
                  c = c + f.line(r, null, "H") + f.line(null, o, "V")) : "straight" === x && (h += f.line(r, o),
                  c += f.line(r, o)),
                  s === e[i].length - 2 && (c = c + f.line(r, b) + f.move(r, o) + "z",
                  d.push(h),
                  g.push(c))
              }
              return {
