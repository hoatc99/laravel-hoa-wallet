...
!function(n) {
  ...
  function l(t, e, n) {
      var a = typeof t
        , r = "string" == a;
      return "number" == a || "bigint" == a || (!!h(t) || (e && r && (t = G(t, e)),
      n && r && (t = t.replace(q, "")),
  ...
  var p, e, t, C = function(t, v) {
      ...
      return this.each(function() {
          ...
          if ("table" != this.nodeName.toLowerCase())
              ...
              null !== t && "" !== t || (t = "DataTables_Table_" + C.ext._unique++,
              this.id = t);
              ...
              h.rowIdFn = A(r.rowId),
              tt(h),
              h.oClasses), g = (P.extend(p, C.ext.classes, r.oClasses),
              l.addClass(p.sTable),
              ...
              if (0 !== t.length && (Ct(h.aoHeader, t[0]),
              m = wt(h)),
              null === r.aoColumns)
                  for (f = [],
                  o = 0,
  ...
  function Z(t) {
      var e, n = C.defaults.oLanguage, a = n.sDecimal;
      a && Me(a),
      t && (e = t.sZeroRecords,
  ...
  C.util = {
      ...
      set: function(a) {
          var d;
          return P.isPlainObject(a) ? C.util.set(a._) : null === a ? function() {}
  ...
  function nt(t, e) {
      ...
      t.aoPreSearchCols);
      n[a] = P.extend({}, C.models.oSearch, n[a]),
      at(t, a, P(e).data())
  }
  function at(t, e, n) {
      function a(t) {
  ...
  function Qt(n) {
      ...
      var e, a, r, o, i, l = n.oScroll, s = l.sX, u = l.sXInner, c = l.sY, l = l.iBarWidth, f = P(n.nScrollHead), d = f[0].style, h = f.children("div"), p = h[0].style, h = h.children("table"), g = n.nScrollBody, b = P(g), m = g.style, S = P(n.nScrollFoot).children("div"), v = S.children("table"), y = P(n.nTHead), D = P(n.nTable), _ = D[0], C = _.style, w = n.nTFoot ? P(n.nTFoot) : null, T = n.oBrowser, x = T.bScrollOversize, A = (H(n.aoColumns, "nTh"),
      ...
      f = D.outerWidth(),
      "" === s ? (C.width = "100%",
      x && (D.find("tbody").height() > g.offsetHeight || "scroll" == b.css("overflow-y")) && (C.width = M(D.outerWidth() - l)),
      f = D.outerWidth()) : "" !== u && (C.width = M(u),
      f = D.outerWidth()),
      k(t, e),
      k(function(t) {
  ...
  function ie(t) {
      var e, n, a, r, c, f = [], u = C.ext.type.order, d = t.aoData, o = (t.aoColumns,
  ...
  function fe(t, e) {
      for (var n, a, r, o = t.aoColumns[e], i = C.ext.order[o.sSortDataType], l = (i && (n = i.call(t.oInstance, t, e, ot(t, e))),
      C.ext.type.order[o.sType + "-pre"]), s = 0, u = t.aoData.length; s < u; s++)
  ...
  C.util.throttle(function(t) {
    ...
    , Ne = (e(je, function(t, e) {
      var n = this.context;
      return t === N ? n.length && this.length ? n[0].aoData[this[0]]._details : N : (!0 === t ? this.child.show() : !1 === t ? Re(this) : n.length && this.length && Te(n[0], n[0].aoData[this[0]], t, e),
      this)
  }),
  ...
  function ke(t, e, n, a) {
      var r;
      return 0 === t || t && "-" !== t ? "number" == (r = typeof t) || "bigint" == r ? t : ((t = e ? G(t, e) : t).replace && (n && (t = t.replace(n, "")),
      a && (t = t.replace(a, ""))),
      +t) : -1 / 0
  }
  function Me(n) {
  ...
  function Ve(s) {
      return function(a, r, o, i) {
          ...
          function(t, e) {
              var n;
              return null !== t && t !== N || (t = "--now" === i ? (n = new Date,
  ...
  return C.datetime = function(n, a) {
      ...
      a = a || "en",
      C.ext.type.order[r] || (C.ext.type.detect.unshift(function(t) {
          var e = Ue(t, n, a);
          return !("" !== t && !e) && r
      }),
